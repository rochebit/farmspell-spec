...
- **1.1.2 Layout Composition**:
  ...
  - **Global Overlay Region**: Host container for [ToastNotification](components/toast-notification.md) alerts and the persistent bottom-corner [VersionBadge](components/version-badge.md).
