...
### 2.2 Input Mechanism & Anti-Assistance Rules
- **2.2.1 Native Keyboard Input**: Spelling challenges accept input via the device's native keyboard, rendering typed letters into corresponding uppercase letter slots.
- **2.2.2 Unassisted Typing**: All operating system and browser keyboard assistance features—including auto-complete, auto-correct, predictive text suggestions, and spellcheck dictionaries—MUST be disabled so the challenge accurately assesses independent spelling.
